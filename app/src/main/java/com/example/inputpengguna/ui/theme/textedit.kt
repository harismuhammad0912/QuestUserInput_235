    ...
    Column(
        ...
        ElevatedCard(
            ...
            Column(
                ...
                Text(text = "Gender : " + jenis, color = Color.White, modifier = Modifier.padding(top = 4.dp))
                Text(text = "Alamat : " + alamat, color = Color.White, modifier = Modifier.padding(top = 4.dp))
            }
        }
    }
}